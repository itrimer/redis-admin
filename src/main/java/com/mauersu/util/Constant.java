...
public interface Constant {
	...
	public static final Map<String, RedisTemplate> 					redisTemplatesMap 		= 	new HashMap<>();
	public static final Map<String, CopyOnWriteArrayList<RKey>> 	redisKeysListMap 		= 	new HashMap<>();
	public static final Map<RKey, Object> 							redisVMCache 			= 	new ConcurrentHashMap<>();
	public static final CopyOnWriteArrayList<ZNode> 				redisNavigateZtree 		= 	new CopyOnWriteArrayList<>();
	public static final CopyOnWriteArrayList<Map<String, Object>>	redisServerCache 		=   new CopyOnWriteArrayList<>();
